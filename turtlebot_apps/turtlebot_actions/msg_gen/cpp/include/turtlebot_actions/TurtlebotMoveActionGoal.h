/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-electric-turtlebot-apps-0.2.3/debian/ros-electric-turtlebot-apps/opt/ros/electric/stacks/turtlebot_apps/turtlebot_actions/msg/TurtlebotMoveActionGoal.msg */
...
struct TurtlebotMoveActionGoal_ {
  ...
  typedef  ::turtlebot_actions::TurtlebotMoveGoal_<ContainerAllocator>  _goal_type;
   ::turtlebot_actions::TurtlebotMoveGoal_<ContainerAllocator>  goal;


private:
  static const char* __s_getDataType_() { return "turtlebot_actions/TurtlebotMoveActionGoal"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "7e462cf7fe57fc76afd36fde5d415bc1"; }
public:
...
}; // struct TurtlebotMoveActionGoal
...
{
template<class ContainerAllocator> struct IsMessage< ::turtlebot_actions::TurtlebotMoveActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::turtlebot_actions::TurtlebotMoveActionGoal_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::turtlebot_actions::TurtlebotMoveActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::turtlebot_actions::TurtlebotMoveActionGoal_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
