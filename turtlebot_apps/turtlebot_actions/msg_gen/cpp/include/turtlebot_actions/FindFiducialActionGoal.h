/* Auto-generated by genmsg_cpp for file /tmp/buildd/ros-electric-turtlebot-apps-0.2.3/debian/ros-electric-turtlebot-apps/opt/ros/electric/stacks/turtlebot_apps/turtlebot_actions/msg/FindFiducialActionGoal.msg */
...
struct FindFiducialActionGoal_ {
  ...
  typedef  ::turtlebot_actions::FindFiducialGoal_<ContainerAllocator>  _goal_type;
   ::turtlebot_actions::FindFiducialGoal_<ContainerAllocator>  goal;


private:
  static const char* __s_getDataType_() { return "turtlebot_actions/FindFiducialActionGoal"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "c6a34d64b9eb5980711e7f6f5b5b4380"; }
public:
...
{
template<class ContainerAllocator> struct IsMessage< ::turtlebot_actions::FindFiducialActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::turtlebot_actions::FindFiducialActionGoal_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::turtlebot_actions::FindFiducialActionGoal_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::turtlebot_actions::FindFiducialActionGoal_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
