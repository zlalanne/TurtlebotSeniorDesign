"""autogenerated by genmsg_py from FindFiducialActionFeedback.msg. Do not edit."""
...
class FindFiducialActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','turtlebot_actions/FindFiducialFeedback']
