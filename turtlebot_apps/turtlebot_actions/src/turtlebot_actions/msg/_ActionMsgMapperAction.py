"""autogenerated by genmsg_py from ActionMsgMapperAction.msg. Do not edit."""
...
class ActionMsgMapperAction(roslib.message.Message):
  _md5sum = "67cd690e758365b02dd8c07f07f28ae8"
  _type = "turtlebot_actions/ActionMsgMapperAction"
...
"""
  ...
  _slot_types = ['turtlebot_actions/ActionMsgMapperActionGoal','turtlebot_actions/ActionMsgMapperActionResult','turtlebot_actions/ActionMsgMapperActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionMsgMapperAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = turtlebot_actions.msg.ActionMsgMapperActionGoal()
      if self.action_result is None:
        self.action_result = turtlebot_actions.msg.ActionMsgMapperActionResult()
      if self.action_feedback is None:
        self.action_feedback = turtlebot_actions.msg.ActionMsgMapperActionFeedback()
    else:
      self.action_goal = turtlebot_actions.msg.ActionMsgMapperActionGoal()
      self.action_result = turtlebot_actions.msg.ActionMsgMapperActionResult()
      self.action_feedback = turtlebot_actions.msg.ActionMsgMapperActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.input_topic
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.output_topic
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.input_type
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.output_type
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.input_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.input_list:
        length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_goal.goal.output_list)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.output_list:
        length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.input_topic = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_goal.goal.output_topic = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_goal.goal.input_type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_goal.goal.output_type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.input_list = []
      for i in range(0, length):
        ...
        val1 = str[start:end]
        self.action_goal.goal.input_list.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.output_list = []
      for i in range(0, length):
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        val1 = str[start:end]
        self.action_goal.goal.output_list.append(val1)
      _x = self
      start = end
      end += 12
